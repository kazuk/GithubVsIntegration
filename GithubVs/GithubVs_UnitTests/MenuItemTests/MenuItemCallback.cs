...
using kazuk.GithubVs;

namespace GithubVs_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new GithubVsPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(kazuk.GithubVs.GuidList.guidGithubVsCmdSet, (int)kazuk.GithubVs.PkgCmdIDList.cmdidMyCommand);
